...
import { EnvelopeClosedIcon, PersonIcon, CalendarIcon, ArchiveIcon, FileIcon } from "@radix-ui/react-icons"
    ...
    return(
        <div className="w-100 mt-4">
            ...
            <div className="border p-4">
                <div className="pt-4 pb-8 fs-5">
                    Détails de l'admin
                </div>
                <div className="d-flex row row-cols-lg-4 row-cols-sm-1 gap-lg-0 gap-sm-4">
                    <div className="d-flex  gap-3 align-items-center">
                        <div className="d-flex justify-content-center align-items-center bg-primary bg-opacity-25 p-2" style={{ width: '45px', height: '45px', borderRadius: "100%" }}>
                ...
                <div className="d-flex row row-cols-lg-4 row-cols-sm-1 gap-lg-0 gap-sm-4">
                    ...
                    <div className="d-flex gap-3 align-items-center">
                        ...
                        <div>
                            ...
                            <div className="fs-5"> 16_04-2002 </div>
                        </div>
                    </div>
                </div>
            </div>
